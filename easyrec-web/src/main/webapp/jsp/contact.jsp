...
<div class="upperbody">
    ...
    <p>
        The easyrec Project is hosted on
        <a target="_blank" href="http://sourceforge.net/projects/easyrec">sourceforge</a>
        as an open source project. It is written in JAVA and can be hosted on your own Server.


        Follow our blog, get useful information in easyrec's wiki or discuss
